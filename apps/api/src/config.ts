...
const envSchema = z.object({
  ...
  FLASH_SOCKET_ENABLED: z.coerce.boolean().default(false),
  FLASH_HOST: z.string().default('127.0.0.1'),
  FLASH_PORT: z.coerce.number().int().positive().default(3250),
  FLASH_SOCKET_ENCRYPTED: z.coerce.boolean().default(true),
